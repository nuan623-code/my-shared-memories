...
- **板块一「系统课程」**(`course/`):线性 14 课,**已全部发布(2026-08-05)**,现处复习修订模式(每天深化/校正一课,进阶主题追加进课表)。
- **板块二「实战 Tip」**(`tips/`):非线性、可检索,每条单页自足;**25 条已全部发布(2026-08-05),backlog 已清空**。之后每天:复核到期 tip(volatility high 且超 14 天),从官方增量补充新选题进 backlog,有存货时每天写 2 条(用户 2026-08-05 定)。
